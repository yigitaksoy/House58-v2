        ...
        <div className="flex justify-end mt-16">
          <Magnetic>
            <Link href="/services">
              <button
                type="button"
                class="border-[1.5px] border-house-black px-6 py-2 flex flex-row text-lg mt-5 font-heavy items-center gap-2 text-house-500 hover:bg-oxfordBlue hover:bg-house-black hover:text-white transition-all duration-300 ease-in-out self-start"
              >
                Go to services
